...
public abstract class ClassUtils {
    ...
    public static Method getMostSpecificMethod(Method method, Class<?> targetClass) {
        if (method != null && isOverridable(method, targetClass) && targetClass != null && targetClass != method.getDeclaringClass()) {
            try {
                ...
                Method specificMethod = ReflectionUtil.findMethod(targetClass, method.getName(), method.getParameterTypes());
    ...
    public static Class<?>[] getAllInterfacesForClass(Class<?> clazz, ClassLoader classLoader) {
        Set<Class<?>> ifcs = (Set<Class<?>>) getAllInterfacesForClassAsSet(clazz, classLoader);
