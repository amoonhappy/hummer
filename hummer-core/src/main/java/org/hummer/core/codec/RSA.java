...
public class RSA implements ICodec {
    private RSAPrivateKey privateKey;
    private RSAPublicKey publicKey;
    private static final ICodec instance = new RSA();
    ...
    public RSA() {
        String publicKeyFilePath = "/rsa_private_key.pem";
        String privateKeyFilePath = "/rsa_public_key.pem";
    ...
    public String getKeyFromFile(String filePath) throws Exception {
        InputStream ips = RSA.class.getResourceAsStream(filePath);
        this.bufferedReader = new BufferedReader(new InputStreamReader(ips));
        String line = null;
